...
export default function Hero() {
  return (
    ...
    >
      <div className="flex flex-col items-start text-left max-w-md rounded-xl p-6 transition duration-300">
        ...
        <div className="flex gap-4 pt-4">
          <a href="https://www.instagram.com/this__is__loki___/" target="_blank" className="hover:text-fuchsia-400">
          ...
          <a href="https://x.com/LokeshLoke9386?t=DOKiD-w0cYTSbSKp9KQjKw&s=09" className="hover:text-gray-500">
            <AiFillTwitterSquare size={30} />
          </a>
        </div>
      </div>

      <div className="border-2 border-teal-500 rounded-full p-2 bg-white/90 shadow-md hover:shadow-teal-600/30 hover:shadow-2xl transition duration-300 transform hover:rotate-1">
        <img
          src={loki2}
          alt="Lokeshwaran"
