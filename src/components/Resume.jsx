      ...
      >
        ...
        <div className="w-full md:w-1/2 flex justify-center items-center">
          <div className="group relative w-[320px] md:w-[380px]">
            ...
            />
            <div className="relative rounded-2xl bg-white/5 ring-1 ring-white/10 backdrop-blur-md shadow-xl transition-all duration-300 group-hover:-translate-y-1 group-hover:rotate-1 group-hover:scale-105 group-hover:shadow-2xl overflow-hidden">
